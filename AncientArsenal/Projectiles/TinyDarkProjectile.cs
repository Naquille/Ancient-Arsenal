...
{
    class TinyDarkProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int dustnumber = Dust.NewDust(projectile.position + randVect, projectile.width, projectile.height, 75, 0f, 0f, 100, default(Color), 1.2f);
